# 7b_w4g128_n32e5_agent

## Directory listing
total 6.1M
-rw-r--r-- 1 root root  431 Jul  7 00:48 command.sh
-rw-r--r-- 1 root root  131 Jul  7 00:49 environment.txt
-rw-r--r-- 1 root root 2.1K Jul  7 00:49 log_rank0_1783356538.txt
...
## Command
/root/autodl-tmp/omniquant_final/env/bin/python -u /root/autodl-tmp/omniquant_final/code/main.py --model /root/autodl-tmp/llama-2-7b-hf --cache_dir /root/autodl-tmp/omniquant_final/restore/OmniQuant/cache --calib_dataset wikitext2 --batch_size 1 --seed 2 --abits 16 --eval_ppl --output_dir /root/autodl-tmp/omniquant_final/experiments/7b_w4g128_n32e5_agent --nsamples 32 --wbits 4 --group_size 128 --epochs 5 --lwc --lwc_lr 0.005 

## Environment
START_EPOCH=1783356534
END_EPOCH=1783356562
ELAPSED_SECONDS=28
RUN_EXIT_CODE=1
GIT_COMMIT=3b25db6413c62581664adf0e6c2dd2f814396bab

## Key result lines
[2026-07-07 00:49:00 root](omniquant.py 247): INFO === Start quantize layer 0 ===
[2026-07-07 00:49:20 root](omniquant.py 247): INFO === Start quantize layer 1 ===
